<template>
    <header v-show="shouldShowNavbar">
      <nav ref="navbar" class="navbar navbar-expand-lg bg-success navbar-dark shadow-lg sticky-top">
  ...
  export default {
    setup() {
      ...
      const navbar = ref(null); // Referencia al navbar
      const navbarHeight = ref(0); // Altura del navbar
      ...
      // Pasar la altura del navbar a los componentes hijos
      ...
      return { shouldShowNavbar, logout, isNavbarOpen, closeNavbar, toggleNavbar, navbar };
    },
  };
  </script>
